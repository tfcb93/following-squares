...
export class Options {
    ...
    clickEvents() {
        this.closeOptionsButton.addEventListener('click', this.closeTrayFunc.bind(this));
        this.openOptionsButton.addEventListener('click', this.openTrayFunc.bind(this));
    }
    ...
    initializeControllers = () => {
        ...
        // square quantity
        this.optionsController.squareQuantity.element.addEventListener('input', this.changeSquareQuantity.bind(this));

        // should return squares or not
        this.optionsController.shouldSquaresReturn.element.yes.addEventListener('change', this.shouldReturnYes.bind(this));
        this.optionsController.shouldSquaresReturn.element.no.addEventListener('change', this.shouldReturnNo.bind(this));
        
        // returnSquaresTimer
        this.optionsController.returnSquaresTimer.element.addEventListener('input', this.setReturnTimer.bind(this));
        
        // Filters
        this.optionsController.filter.element.addEventListener('input', this.selectFilter.bind(this));
